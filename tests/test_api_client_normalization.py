...
def test_api_client_strips_public_path():
    ...
    client = APIClient(base_url="https://api.s1.show/public", token="test-token")
...
def test_api_client_strips_trailing_slash():
    ...
    client = APIClient(base_url="https://api.platform.softwareone.com/", token="test-token")
...
def test_api_client_strips_any_path():
    ...
    client = APIClient(base_url="https://api.s1.show/v1/api/anything", token="test-token")
    assert client.base_url == "https://api.s1.show"
...
def test_api_client_preserves_port():
    ...
    client = APIClient(base_url="http://localhost:8080/some/path", token="test-token")
    assert client.base_url == "http://localhost:8080"


def test_api_client_handles_http_protocol():
    """Test that http:// protocol is handled correctly"""
    client = APIClient(base_url="http://api.example.com/path", token="test-token")
...
def test_api_client_handles_subdomain():
    ...
    client = APIClient(base_url="https://api.staging.platform.softwareone.com/public/v1", token="test-token")
