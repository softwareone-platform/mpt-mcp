...
class TestDidYouMeanSuggestions:
    ...
    async def test_unknown_resource_suggests_similar(self):
        ...
        from src.server import marketplace_query, initialize_cache, endpoint_registry
        ...
        mock_registry = {
            ...
            "catalog.products.by_id": {"path": "/public/v1/catalog/products/{id}", "summary": "Product by ID", "parameters": []},
